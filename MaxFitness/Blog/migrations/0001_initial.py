    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Weight loss', 'Weight loss'), ('Weight gain', 'Weight gain'), ('Food', 'Food'), ('Health', 'Health'), ('Muscle gain', 'Muscle gain'), ('Yoga', 'Yoga')], max_length=300)),
